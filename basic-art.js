...
const quizQuestions = [
    {
        id: 1,
        question: "งานศิลปะคืออะไร",
        options: [
            { id: "A", text: "การเขียนโปรแกรม" },
            { id: "B", text: "การแสดงออกทางความคิดและอารมณ์" },
            { id: "C", text: "การคำนวณตัวเลข" },
            { id: "D", text: "การจัดเก็บข้อมูล" }
        ],
        answer: "B"
    },
    {
        id: 2,
        question: "ข้อใดเป็นวัตถุประสงค์ของงานศิลปะ",
        options: [
            { id: "A", text: "การสื่อสาร" },
            { id: "B", text: "การแสดงความสวยงาม" },
            { id: "C", text: "การถ่ายทอดความหมาย" },
            { id: "D", text: "ถูกทุกข้อ" }
        ],
        answer: "D"
    },
    {
        id: 3,
        question: "การเรียนศิลปะช่วยพัฒนาอะไร",
        options: [
            { id: "A", text: "ความจำ" },
            { id: "B", text: "ความคิดสร้างสรรค์" },
            { id: "C", text: "การคำนวณ" },
            { id: "D", text: "ความเร็วอินเทอร์เน็ต" }
        ],
        answer: "B"
    },
    {
        id: 4,
        question: "ข้อใด “ไม่ใช่” องค์ประกอบศิลป์",
        options: [
            { id: "A", text: "เส้น" },
            { id: "B", text: "สี" },
            { id: "C", text: "เสียง" },
    ...
    {
        id: 5,
        question: "เส้นตรง (Line) ให้ความรู้สึกอย่างไร",
        options: [
            { id: "A", text: "อ่อนโยน" },
            { id: "B", text: "เคลื่อนไหว" },
            { id: "C", text: "มั่นคง" },
            { id: "D", text: "วุ่นวาย" }
        ],
        answer: "C"
    ...
    {
        id: 6,
        question: "Shape และ Form ต่างกันอย่างไร",
        options: [
            { id: "A", text: "Shape มีสี Form ไม่มี" },
            { id: "B", text: "Shape เป็น 2 มิติ Form เป็น 3 มิติ" },
            { id: "C", text: "Shape ใช้ใน AI เท่านั้น" },
    ...
    {
        id: 7,
        question: "ข้อใดเป็น “สีหลัก (Primary Color)”",
        options: [
            { id: "A", text: "เขียว ม่วง ส้ม" },
            { id: "B", text: "แดง เหลือง น้ำเงิน" },
            { id: "C", text: "ดำ ขาว เทา" },
            { id: "D", text: "ฟ้า ชมพู น้ำตาล" }
        ],
        answer: "B"
    },
    {
        id: 8,
        question: "Texture หมายถึงอะไร",
        options: [
            { id: "A", text: "สีของภาพ" },
            { id: "B", text: "ความคมชัด" },
            { id: "C", text: "ลักษณะพื้นผิว" },
            { id: "D", text: "ขนาดภาพ" }
        ],
        answer: "C"
    },
    {
        id: 9,
        question: "ข้อใดคือหลักการออกแบบ (Principle of Design)",
        options: [
            { id: "A", text: "ความสมดุล" },
            { id: "B", text: "ความกลมกลืน" },
            { id: "C", text: "การเน้น" },
            { id: "D", text: "ถูกทุกข้อ" }
        ],
        answer: "D"
    ...
    {
        id: 10,
        question: "งานศิลปะสามารถนำไปใช้ในด้านใด",
        options: [
            { id: "A", text: "งานโฆษณา" },
            { id: "B", text: "Social Media" },
            { id: "C", text: "ออกแบบ Poster" },
            { id: "D", text: "ถูกทุกข้อ" }
        ],
        answer: "D"
    }
